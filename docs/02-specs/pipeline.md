...
| S6 | Rank and notify | All lots complete | Rough max bid with the selected cost profile, opportunity score scaled against the best lot in the catalogue, email user. | None | Updated lots, notification | Seconds |
